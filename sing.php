            ...
            <div class="mb-10">
                <div class="p-3">
                    <form method="POST" class="row g-3" action="sing.php">
                        ...
                        <div class="mb-3 col-12">
                            <label for="apellido">Contraseña de administrador</label>
                            <input type="password" class="form-control" name="contrasena">

                            <div class="d-grid gap-2 d-md-block mt-3 mb-4">
                                <div class="text-center d-grid gap-2 col-12 mx-auto">
                                    <button value="ingresar" name="ingresar" type="submit" class="btn btn-secondary">Ingresar</button>
                                </div>
                            </div>
                            <div class="d-grid gap-2 d-md-block mt-3 mb-4">
                                <div class="text-center d-grid gap-2 col-12 mx-auto">
                    ...
                    if (isset($_POST['ingresar'])) {
                        ...
                        echo "<div class='alert alert-danger alert-dismissible fade show fixed-top' role='alert'>
                                Los datos ingresados no coinciden :'c
                                <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                                </div>";
                    }
                }
